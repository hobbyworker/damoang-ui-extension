...
- 빠른 프로필 보기: 자주 보는 회원을 등록해 두고 팝업에서 프로필로 바로 이동. 프로필 화면의 눈 모양 버튼이나 닉네임 입력으로 등록
- 프로필 보던 탭 기억: 회원 프로필에서 글을 보고 돌아오면 보던 탭과 스크롤 위치로 복원
- 공감 목록 쉬운 메모: 공감한 사람들 목록에서 메모를 작성하거나 삭제해도 스크롤 유지
...
- App Store (Safari, macOS·iOS): https://apps.apple.com/app/id6807649371
